...
H1 = tf.layers.dense(batch_X, node_num, activation=tf.nn.relu,
                        kernel_initializer=He_init, name="H1")

H2 = tf.layers.dense(H1, node_num, activation=tf.nn.relu,
                        kernel_initializer=He_init, name="H2")

H3 = tf.layers.dense(H2, node_num, activation=tf.nn.relu,
                        kernel_initializer=He_init, name="H3")

H4 = tf.layers.dense(H3, node_num, activation=tf.nn.relu,
                        kernel_initializer=He_init, name="H4")

H5 = tf.layers.dense(H4, node_num, activation=tf.nn.relu,
                        kernel_initializer=He_init, name="H5")

Y_hat = tf.layers.dense(H5, output_num, name="outputs")
